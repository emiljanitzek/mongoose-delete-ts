...
type TestDeletedByModel = Model<TestDeletedBy, TestQueryHelpers, DeletedMethods & DeletedByMethods> &
	DeletedInstanceMethods<TestDeletedBy, TestQueryHelpers> &
	DeletedByInstanceMethods<TestDeletedBy, Types.ObjectId, TestQueryHelpers>;
...
type TestDeletedByStringModel = Model<TestDeletedByString, TestDeletedByStringQueryHelpers, DeletedMethods & DeletedByMethods<string>> &
	DeletedInstanceMethods<TestDeletedByString, TestDeletedByStringQueryHelpers> &
	DeletedByInstanceMethods<TestDeletedByString, string, TestDeletedByStringQueryHelpers>;
