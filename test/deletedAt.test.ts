import { Deleted, DeletedAt, DeletedInstanceMethods, DeletedMethods, DeletedQueryHelpers } from '../source';
...
type TestDeletedAtModel = Model<TestDeletedAt, TestQueryHelpers, DeletedMethods> & DeletedInstanceMethods<TestDeletedAt, TestQueryHelpers>;
